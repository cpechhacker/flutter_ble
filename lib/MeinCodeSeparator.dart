...
/*    txSub = txChar.value.listen((value) {
  ...
  void writeData(Color color) async {
    ...
    txSub = txChar.value.listen((value) async {
      //print("New value");
...
/*    try {
      ...
      // await rxChar.write(utf8.encode("33"), withoutResponse: true);
      timer = null;
